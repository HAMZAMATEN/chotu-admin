...
class AddShopProductDialog extends StatefulWidget {
  ...
  const AddShopProductDialog({super.key, required this.storeModel});
              ...
              if (_formKey.currentState!.validate()) {
                ...
                if (double.parse(priceController.text) <
                  ...
                  Map<String,dynamic> body = {
                    ...
                    'store_id':'${widget.storeModel.id}',
                  };
                  await provider.addProductToDataBase(body, context);
                  await provider.getStoreProducts(storeId: widget.storeModel.id!);
...
void showAddShopProductDialog(BuildContext context, StoreModel storeModel) {
  showDialog(
    context: context,
    builder: (context) => Container(
        child: AddShopProductDialog(
