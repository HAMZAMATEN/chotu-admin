      ...
      child: ListView(
        children: [
          ...
          DrawerListTile(
            ...
            press: () {
              context.mainScreenProvider.navigateToScreen('Riders');
            },
          ),
          DrawerListTile(
            title: "Category",
          ...
          DrawerListTile(
            ...
            press: () {
              context.mainScreenProvider.navigateToScreen('Product');
            },
          ),
          DrawerListTile(
            title: "Shop",
            ...
            press: () {
              context.mainScreenProvider.navigateToScreen('Shop');
            },
          ),
          DrawerListTile(
            title: "Users",
          ...
          DrawerListTile(
            ...
            svgSrc: "assets/icons/menu_profile.svg",
            press: () {
              context.mainScreenProvider.navigateToScreen('Communication');
            },
          ),
          DrawerListTile(
            ...
            press: () {
              context.mainScreenProvider.navigateToScreen('Analytics');
            },
          ),
          // DrawerListTile(
          //   title: "Posters",
